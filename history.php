...
<head>
    <meta charset="UTF-8">
    <title>TutorFlow | Session History</title>
    ...
    <main class="main-content">
        <header class="dashboard-header">
            <div class="header-info">
                ...
                <p>Completed and past sessions will appear here.</p>
            </div>
            <div class="user-pill">
        ...
        <div class="scroll-area">
            <div class="client-table glass-effect">
                <div class="table-header">
                    <h3><i class="fas fa-history"></i> History (placeholder)</h3>
                </div>
                    ...
                    <table class="compact-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><span class="tag-eng">TBD</span></td>
                                <td>-</td>
                                <td>-</td>
